namespace NServiceBus.Core.Tests.Routing
{
    ...
    public class MessageDrivenSubscribeTerminatorTests
    {
        ...
        public async Task Should_include_TimeSent_and_Version_headers()
        {
            ...
            await subscribeTerminator.Invoke(new TestableSubscribeContext(), (c, t) => Task.CompletedTask, CancellationToken.None);
            await unsubscribeTerminator.Invoke(new TestableUnsubscribeContext(), (c, t) => Task.CompletedTask, CancellationToken.None);
        ...
        public async Task Should_Dispatch_according_to_max_retries_when_dispatch_fails()
        {
            ...
            await subscribeTerminator.Invoke(context, (c, t) => Task.CompletedTask, CancellationToken.None);
