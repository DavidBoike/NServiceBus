namespace NServiceBus.Core.Tests.Routing
{
    ...
    public class DetermineRouteForReplyBehaviorTests
    {
        ...
        public async Task Should_default_to_reply_address_of_incoming_message_for_replies()
        {
            ...
            await behavior.Invoke(context, (c, t) =>
            {
        ...
        public void Should_throw_if_incoming_message_has_no_reply_to_address()
        {
            ...
            Assert.That(async () => await behavior.Invoke(context, (c, t) => Task.CompletedTask, CancellationToken.None), Throws.InstanceOf<Exception>().And.Message.Contains(typeof(MyReply).FullName));
        }
